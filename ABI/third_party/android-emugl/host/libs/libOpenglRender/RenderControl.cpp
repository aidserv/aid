...
public:
    GrallocSync() {
        ...
        mEnabled = true; // emugl_feature_is_enabled(android::featurecontrol::GrallocSync);
...
GrallocSync gGrallocSync;
GrallocSync *sGrallocSync = &gGrallocSync;
...
static EGLint rcGetGLString(EGLenum name, void* buffer, EGLint bufferSize)
{
    ...
    bool glesDynamicVersionEnabled = true;	// 动态获取版本
...
#if 1
void MyinitRenderControlContext(renderControl_server_context_t *dec)
{
    dec->rcGetRendererVersion = rcGetRendererVersion;
    dec->rcGetEGLVersion = rcGetEGLVersion;
    dec->rcQueryEGLString = rcQueryEGLString;
