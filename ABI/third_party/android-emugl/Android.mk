...
####fix sheng add ####
include $(EMUGL_PATH)/android/android-emu.mk
...
#include $(EMUGL_PATH)/host/libs/EGL_dec/Android.mk
...
##include $(EMUGL_PATH)/renderer/Android.mk
##endif
#include $(EMUGL_PATH)/event_injector/Android.mk
#include $(EMUGL_PATH)/android-renderer/Android.mk
